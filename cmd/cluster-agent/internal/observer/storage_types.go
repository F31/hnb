...
// StorageInventory is the optional RT-011 partition carried on the same
// generation/sequence cursor and Full/Delta mode as the enclosing observation.
type StorageInventory struct {
	StorageClasses         []StorageClassFact          `json:"storageClasses"`
	CSIDrivers             []CSIDriverFact             `json:"csiDrivers"`
	CSINodes               []CSINodeFact               `json:"csiNodes"`
	CSIStorageCapacities   []CSIStorageCapacityFact    `json:"csiStorageCapacities"`
	VolumeAttachments      []VolumeAttachmentFact      `json:"volumeAttachments"`
