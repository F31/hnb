...
var apiserverRoutes = []iam.RouteMetadata{
	...
	{Method: http.MethodGet, Pattern: "/api/v1/plugin-catalog", ResourceKind: "pluginCatalog", Action: iam.ActionRead},
	{Method: http.MethodPost, Pattern: "/api/v1/plugin-catalog/installs", ResourceKind: "pluginCatalog", Action: iam.ActionExecute},
	{Method: http.MethodDelete, Pattern: "/api/v1/plugin-catalog/installs/{name}", ResourceKind: "pluginCatalog", ResourceIDParam: "name", Action: iam.ActionExecute},
