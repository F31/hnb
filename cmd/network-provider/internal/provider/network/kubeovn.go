...
func (p *KubeOVNProvider) Install(ctx context.Context, profile *provider.NetworkProfile, target *provider.RuntimeTarget) error {
...
func (p *KubeOVNProvider) Uninstall(ctx context.Context, profile *provider.NetworkProfile, target *provider.RuntimeTarget) error {
...
func (p *KubeOVNProvider) Upgrade(ctx context.Context, profile *provider.NetworkProfile, target *provider.RuntimeTarget, version string) error {
	if version == "" {
		version = profile.Version
	}
...
func (p *KubeOVNProvider) Capability() provider.NetworkCapability {
...
func (p *KubeOVNProvider) Health(ctx context.Context, target *provider.RuntimeTarget) error {
...
func (p *KubeOVNProvider) renderValues(profile *provider.NetworkProfile) (string, error) {
	vals := map[string]any{}
